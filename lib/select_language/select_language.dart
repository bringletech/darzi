...
import 'package:darzi/select_language/select_lang_controller.dart';
...
class SelectLanguage extends StatefulWidget {
  ...
  const SelectLanguage({super.key, required this.onChangeLanguage});
...
class _SelectLanguageState extends State<SelectLanguage> {
  ...
  String tailorLabel = StringConstant.tailor;
  // Default Tailor label
  String customerLabel = StringConstant.customer;
